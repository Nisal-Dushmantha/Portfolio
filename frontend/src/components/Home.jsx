    ...
    <PageTransition>
      <div className="min-h-screen bg-white relative selection:bg-red-500 selection:text-white">
        ...
        <div className="fixed inset-0 z-0 pointer-events-none">
          <Particles particleCount={50} color={'239,68,68'} maxSize={3} maxVelocity={0.5} linkDistance={110} />
        </div>
        ...
        <nav className="fixed top-8 right-8 z-50">
          <div className="hidden md:flex items-center space-x-7 bg-white/90 backdrop-blur-xl px-7 py-3 rounded-full border border-gray-200/80 shadow-xl">
            <button 
              onClick={() => scrollToSection('hero')}
              className={`transition-colors font-semibold text-xs uppercase tracking-wider ${
                activeSection === 'hero' ? 'text-red-600' : 'text-gray-600 hover:text-gray-950'
              }`}
            >
              Home
            </button>
            <button 
              ...
              className="text-gray-600 hover:text-gray-950 transition-colors font-semibold text-xs uppercase tracking-wider"
            >
              Stack
            </button>
            <button 
              ...
              className={`transition-colors font-semibold text-xs uppercase tracking-wider ${
                activeSection === 'projects' ? 'text-red-600' : 'text-gray-600 hover:text-gray-950'
              }`}
            >
              Projects
            </button>
            <button 
              ...
              className={`transition-colors font-semibold text-xs uppercase tracking-wider ${
                activeSection === 'experience' ? 'text-red-600' : 'text-gray-600 hover:text-gray-950'
              }`}
            >
              Experience
            </button>
            <button 
              ...
              className={`transition-colors font-semibold text-xs uppercase tracking-wider ${
                activeSection === 'education' ? 'text-red-600' : 'text-gray-600 hover:text-gray-950'
              }`}
            >
              Education
            </button>
            <button 
              ...
              className={`transition-colors font-semibold text-xs uppercase tracking-wider ${
                activeSection === 'contact' ? 'text-red-600' : 'text-gray-600 hover:text-gray-950'
              }`}
            >
              Contact
            </button>
          ...
          {mobileMenuOpen && (
            <div className="md:hidden absolute top-16 right-0 bg-white/95 backdrop-blur-xl rounded-3xl border border-gray-200 shadow-2xl p-5 min-w-[220px]">
              <div className="space-y-3">
                <button 
                  onClick={() => scrollToSection('hero')}
                  className="block w-full text-left font-semibold py-2 text-sm text-gray-700 hover:text-red-600"
                >
                  Home
                </button>
                <button 
        ...
        {/* Hero Section */}
        <section id="hero" className="min-h-screen flex items-center bg-gradient-to-b from-white via-red-50/20 to-white pt-28 pb-16 relative">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
              ...
              <div className="lg:col-span-6 space-y-7">
                ...
                <div className="flex flex-wrap items-center gap-3">
                  <div className="inline-flex items-center gap-2.5 bg-emerald-50 border border-emerald-200/80 px-3.5 py-1.5 rounded-full shadow-sm">
                  ...
                  {currentTime && (
                    <div className="inline-flex items-center gap-2 bg-gray-100/90 border border-gray-200 px-3 py-1.5 rounded-full text-xs text-gray-600 font-mono">
                ...
                <div className="space-y-3">
                  ...
                  <h1 className="text-4xl sm:text-6xl font-black text-gray-950 tracking-tight leading-none">
                    Nisal <span className="text-red-700">Dushmantha</span>
                  </h1>
                ...
                <p className="text-base sm:text-lg text-gray-600 leading-relaxed max-w-xl">
                  Undergraduate at <span className="font-semibold text-gray-900">SLIIT</span> passionate about engineering resilient full-stack platforms, native Android applications, and human-centered design systems.
                </p>
                ...
                <div className="flex flex-wrap gap-4 pt-2">
                  <button 
                    onClick={() => scrollToSection('projects')}
                    className="bg-gray-950 hover:bg-red-700 text-white px-7 py-3.5 rounded-2xl font-semibold text-sm transition-all duration-300 hover:scale-105 shadow-xl shadow-gray-950/15 flex items-center gap-2 group"
                  >
                  ...
                  <a 
                    ...
                    className="border-2 border-gray-300 hover:border-gray-900 text-gray-800 hover:text-gray-950 px-6 py-3.5 rounded-2xl font-semibold text-sm transition-all duration-300 flex items-center gap-2 hover:scale-105 bg-white shadow-sm"
                  >
                    <FaDownload className="text-xs text-red-600" />
                    Download Resume
                  </a>
                </div>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 pt-6 border-t border-gray-200/80">
                  <div className="bg-gray-50/80 p-3.5 rounded-2xl border border-gray-200/80">
                    ...
                    <div className="text-xs font-semibold text-gray-600">Projects Built</div>
                  </div>
                  <div className="bg-gray-50/80 p-3.5 rounded-2xl border border-gray-200/80">
                    <div className="text-2xl font-black text-red-700">3+</div>
                    <div className="text-xs font-semibold text-gray-600">Years Coding</div>
                  </div>
                  <div className="bg-gray-50/80 p-3.5 rounded-2xl border border-gray-200/80">
                    <div className="text-2xl font-black text-red-700">&lt;24h</div>
                    <div className="text-xs font-semibold text-gray-600">Response Time</div>
                  </div>
                  <div className="bg-gray-50/80 p-3.5 rounded-2xl border border-gray-200/80">
                    <div className="text-2xl font-black text-red-700">100%</div>
                    <div className="text-xs font-semibold text-gray-600">Dedication</div>
                  </div>
                </div>
              </div>
              ...
              <div className="lg:col-span-6 flex justify-center items-center relative">
                <div className="relative w-full max-w-md">
                  ...
                  <div className="absolute -inset-4 bg-gradient-to-tr from-red-600 via-rose-500 to-amber-500 rounded-[2.5rem] blur-2xl opacity-25 animate-pulse" />
                  
                  {/* Photo Container */}
                  <div className="relative z-10 rounded-[2.5rem] overflow-hidden bg-white p-2 shadow-2xl border border-gray-100 group">
                    <div className="relative rounded-[2.2rem] overflow-hidden bg-gray-100 aspect-square">
                      <img
                  ...
                  <motion.div 
                    ...
                    className="absolute -top-4 -right-4 z-20 bg-white/95 backdrop-blur-md px-4 py-2.5 rounded-2xl border border-gray-200/90 shadow-xl flex items-center gap-2.5"
                  >
                    <span className="text-xl">⚛️</span>
                    <div>
                      <div className="text-[11px] font-bold text-gray-900">MERN Full-Stack</div>
                      <div className="text-[9px] font-semibold text-emerald-600">Production Ready</div>
                    </div>
                  </motion.div>
                  ...
                  <motion.div 
                    ...
                    whileHover={{ scale: 1.05 }}
                    className="absolute -bottom-4 -left-4 z-20 bg-white/95 backdrop-blur-md px-4 py-2.5 rounded-2xl border border-gray-200/90 shadow-xl flex items-center gap-2.5"
                  >
                    <span className="text-xl">📱</span>
                    <div>
                      <div className="text-[11px] font-bold text-gray-900">Android & Kotlin</div>
                      <div className="text-[9px] font-semibold text-purple-600">Native UI/UX</div>
                    </div>
                  </motion.div>
                  ...
                  <motion.div 
                    ...
                    whileHover={{ scale: 1.05 }}
                    className="absolute bottom-6 -right-5 z-20 bg-gray-950/90 backdrop-blur-md text-white px-3.5 py-2 rounded-2xl border border-gray-800 shadow-xl flex items-center gap-2"
                  >
        ...
        <section id="skills" className="py-24 bg-white relative">
          <div className="max-w-6xl mx-auto px-6">
            <div className="text-center mb-14">
              <div className="inline-flex items-center gap-2 px-3 py-1 bg-red-50 text-red-700 rounded-full text-xs font-bold uppercase tracking-wider mb-3">
                <FaLayerGroup className="text-xs" />
                TECHNICAL EXPERTISE
              </div>
              <h2 className="text-4xl lg:text-5xl font-black text-gray-950 tracking-tight">
        ...
        <section id="projects" className="py-24 bg-gradient-to-b from-white via-gray-50/60 to-white relative">
          <div className="max-w-6xl mx-auto px-6">
            {/* Section Header */}
            <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
              ...
              {/* Filter Pills */}
              <div className="flex flex-wrap gap-2 bg-gray-100/80 p-1.5 rounded-2xl border border-gray-200 self-start md:self-auto">
                {[
            ...
            <div className="mt-14 pt-8 border-t border-gray-200/80 flex flex-col sm:flex-row items-center justify-between gap-6">
              ...
              <Link
                to="/projects"
                className="inline-flex items-center gap-3 bg-gray-950 hover:bg-red-700 text-white px-8 py-3.5 rounded-2xl font-medium text-sm transition-all duration-300 hover:scale-105 shadow-md shadow-gray-900/10 group"
              >
        ...
        <section id="education" className="py-24 bg-gray-50/60 border-t border-gray-100 relative">
          <div className="max-w-6xl mx-auto px-6">
            <div className="text-center mb-14">
              <div className="inline-flex items-center gap-2 px-3 py-1 bg-red-50 text-red-700 rounded-full text-xs font-bold uppercase tracking-wider mb-3">
                <FaGraduationCap className="text-xs text-red-600" />
                ACADEMIC BACKGROUND
              </div>
              <h2 className="text-4xl lg:text-5xl font-black text-gray-950 tracking-tight">
                Educational Qualifications
        ...
        {/* Contact Section */}
        <section id="contact" className="py-24 bg-gradient-to-b from-white via-gray-50 to-gray-100 relative">
          <div className="max-w-6xl mx-auto px-6">
            <div className="text-center mb-12">
              <div className="inline-flex items-center gap-2 px-3 py-1 bg-red-50 text-red-700 rounded-full text-xs font-bold uppercase tracking-wider mb-3">
                LET'S TALK
              </div>
              <h2 className="text-4xl lg:text-5xl font-black text-gray-950 mb-4 tracking-tight">
                Get In Touch
              </h2>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-start">
              <div className="space-y-8 bg-white p-8 rounded-3xl border border-gray-200/90 shadow-lg">
                <div>
                  <h3 className="text-2xl font-bold text-gray-900 mb-6">Contact Channels</h3>
                  <div className="space-y-5">
                    <div className="flex items-center gap-4">
                      <div className="w-12 h-12 bg-red-50 rounded-2xl flex items-center justify-center">
                        <FaEnvelope className="text-red-700 text-lg" />
                      </div>
                      <div>
                        <p className="font-bold text-gray-900 text-sm">Direct Email</p>
                        <a href="mailto:lawanyanisal@gmail.com" className="text-gray-600 hover:text-red-700 transition-colors text-sm">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 text-sm">Kaduwela, Sri Lanka (Remote-ready)</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="flex gap-3">
                    <a
                      ...
                      className="w-12 h-12 bg-gray-900 rounded-2xl flex items-center justify-center text-white hover:bg-gray-800 transition-all hover:scale-110 shadow-md"
              ...
              {/* Form */}
              <div className="bg-white p-8 rounded-3xl border border-gray-200/90 shadow-lg">
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      disabled={isLoading}
                      className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-2xl focus:outline-none focus:border-red-500 focus:bg-white focus:ring-2 focus:ring-red-500/20 text-gray-900 placeholder-gray-400 text-sm transition-all"
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={handleChange}
                      disabled={isLoading}
                      className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-2xl focus:outline-none focus:border-red-500 focus:bg-white focus:ring-2 focus:ring-red-500/20 text-gray-900 placeholder-gray-400 text-sm transition-all resize-none"
