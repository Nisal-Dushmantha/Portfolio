              ...
              <div className="w-48 h-48 mx-auto">
                {profile.profileImage ? (
                  <img 
                    ...
                    alt={profile.name}
                    className="w-full h-full rounded-3xl object-cover border-4 border-gray-200 shadow-xl"
                  />
                ) : (
                  <div className="w-full h-full bg-gradient-to-br from-blue-600 to-purple-600 rounded-3xl flex items-center justify-center border-4 border-gray-200 shadow-xl">
              ...
              <div className="bg-white rounded-3xl p-8 border border-gray-200">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                  {profile.skills && profile.skills.map((skill, index) => (
                    <div 
                      key={index}
                      className="bg-gray-100 border border-gray-200 text-gray-700 px-4 py-3 rounded-xl text-center font-medium hover:border-red-700 hover:text-red-700 hover:shadow-md transition-all duration-200 hover:-translate-y-1"
                    >
                      {skill}
                    </div>
                  ))}
                ...
                <div className="space-y-3">
                  {profile.socialLinks?.linkedin && (
                    <a 
                      ...
                      className="flex items-center gap-4 p-4 bg-gray-50 rounded-2xl border border-gray-200 hover:shadow-md transition-all duration-200 hover:-translate-y-1 group"
                    >
                  ...
                  {profile.socialLinks?.github && (
                    <a 
                      ...
                      className="flex items-center gap-4 p-4 bg-gray-50 rounded-2xl border border-gray-200 hover:shadow-md transition-all duration-200 hover:-translate-y-1 group"
                    >
                      <div className="w-12 h-12 bg-gray-200 rounded-2xl flex items-center justify-center group-hover:bg-gray-300 transition-colors">
